...
- **Sales by segment** (donut) and **profit by category** (bar)
- **Top 10 products by profit**
- **Sales by region**
- **Sales trend by year** (2011–2014)
- **Interactive filters** — Order Priority (Critical/High/Low/Medium) and Ship Mode (First Class/Same Day/Second Class/Standard Class)
...
| Total Orders | 51,290 |
| Profit Margin | 11.61% |
| Sales CAGR (2011–2014) | ~24% |

- The **Central region** drives 22% of total company profit on its own.
- The **Tables** sub-category is losing money overall (-$64K on $757K in sales).
